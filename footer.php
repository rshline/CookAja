                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>C</span>ookAja</h2>
                            <p>Platform Website Memasak Kelas Dunia!</p>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="images/home/gambar1.png" alt="" />
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-sm-offset-1">
                        <div class="single-widget">
                            <h2>Tentang CookAja</h2>
                            <form action="https://mail.google.com/mail/u/0/" class="searchform">
                                <input type="text" placeholder="Masukkan Alamat E-mail" />
                                <button type="submit" class="btn btn-default"><i class="fa fa-arrow-circle-o-right"></i></button>
                                <p>Lihat Berita terbaru dari Kami <br />Disitus CookAja.com...</p>
                            </form>
                        </div>
                    </div>
